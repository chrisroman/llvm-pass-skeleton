; ModuleID = 'benchmark1.replace-null.ll'
...
if.end:                                           ; preds = %if.then, %entry
  %num.0 = phi i32* [ %0, %if.then ], [ null, %entry ]
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %if.end
  %i.0 = phi i32 [ 0, %if.end ], [ %inc, %for.inc ]
  %mul = mul nsw i32 %argc, 100000000
  %cmp1 = icmp slt i32 %i.0, %mul
  br i1 %cmp1, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %1 = load i32, i32* %num.0, align 4
  %add = add nsw i32 %1, 1
  store i32 %add, i32* %num.0, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %2 = load i32, i32* %num.0, align 4
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 %2)
  ret i32 0
}
