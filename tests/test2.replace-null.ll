; ModuleID = 'test2.mpass.ll'
source_filename = "test2.cpp"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.12.0"

@_ZL5nullp = internal global i8* null, align 8
@0 = private unnamed_addr constant [33 x i8] c"Found a null pointer. Exiting...\00", align 1

; Function Attrs: noinline nounwind ssp uwtable
define void @_Z10deref_nullPc(i8* %p) #0 {
entry:
...
entry:
  ...
  call void @_ZL6escapePv(i8* bitcast (i8** @_ZL5nullp to i8*))
  call void @_Z10deref_nullPc(i8* bitcast (i8** @_ZL5nullp to i8*))
  ret i32 0
}

; Function Attrs: noinline nounwind ssp uwtable
define internal void @_ZL6escapePv(i8* %p) #0 {
entry:
  %p.addr = alloca i8*, align 8
  store i8* %p, i8** %p.addr, align 8
  %0 = load i8*, i8** %p.addr, align 8
  call void asm sideeffect "", "imr,~{memory},~{dirflag},~{fpsr},~{flags}"(i8* %0) #2, !srcloc !3
  ret void
}

define void @nullcheck(i8*) {
  %2 = icmp eq i8* %0, bitcast (i8** @_ZL5nullp to i8*)
  %3 = call i32 (...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @0, i32 0, i32 0))
